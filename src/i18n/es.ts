...
export const es = {
  ...
  settings: {
    ...
    banxicoHint:
      "Con un token gratuito de Banxico puedes traer la tasa de la última subasta de CETES y la tasa objetivo con un clic en el formulario de inversiones.",
    banxicoToken: "Token de la API SIE",
    banxicoTokenPlaceholder: "Pega aquí tu token…",
    banxicoGetToken: "Obtener token gratuito",
